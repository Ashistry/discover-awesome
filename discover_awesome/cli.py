...
def main():
    ...
    define_parser.add_argument('--buildDatabase', '-b', type=str, required=True, help='Build all 4 databases of repos directly from the Gihub API. Requires a personal access token to be passed.')
